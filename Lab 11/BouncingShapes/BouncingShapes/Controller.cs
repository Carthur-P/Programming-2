...
namespace BouncingShapes
{
    public class Controller
    {
        ...
        public void ChangeGreenBallVelocity (Point velocity)//changing the velocity of the green ball by the value from the trackbar
        {
            balls[0].Velocity = velocity;
        }

        public void ChangeRedBallVelocity(Point velocity)//changing the velocity of the red ball by the value from the trackbar
        {
            balls[1].Velocity = velocity;
        }

        public void ChangeBlueBallVelocity(Point velocity)//changing the velocity of the blue ball by the value from the trackbar
        {
            balls[TWO].Velocity = velocity;
        }
    }
}
